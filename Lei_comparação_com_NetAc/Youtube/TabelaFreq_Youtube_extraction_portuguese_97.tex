...
\textbf {\huge In Youtube\_extraction\_portuguese\_97.json :}\newline \par\Large\textbf {Title: \large  Refugiados reconstroem a vida em Portugal }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/22 occurences of hate speech related comments.\end{itemize}\end{document}