...
for n in range(1,205):
    ...
    if (n==35 or n== 3 or n==36 or n==90 or n==181 or n==183 or n==189 or n== 191 or n==197 or n==203):
        ...
        pdf = pdfplumber.open('sol_pdf/TabelaFreq_Sol_extraction_portuguese_' + str(n) + '.pdf')
        print(str(n))
        pages = pdf.pages
        ...
        d["sol-extraction-portuguese-" + str(n) + '.pdf'] = [n_comentarios,n_ocorrencia,percentagem]
        pdf.close()
...
def gerarTabela(d):
    ...
    texfilename ="Resultados_NetAC_Sol.tex"
