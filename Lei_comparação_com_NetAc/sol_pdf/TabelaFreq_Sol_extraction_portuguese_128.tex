...
\textbf {\huge In Sol\_extraction\_portuguese\_128.json :}\newline \par\Large\textbf {Title: \large  Malta introduziu o divórcio há seis anos. Agora prepara-se para o casamento gay }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/6 occurences of hate speech related comments.\end{itemize}\end{document}