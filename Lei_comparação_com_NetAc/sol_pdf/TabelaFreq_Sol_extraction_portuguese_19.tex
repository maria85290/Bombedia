...
\textbf {\huge In Sol\_extraction\_portuguese\_19.json :}\newline \par\Large\textbf {Title: \large  'O público continua com as pessoas em quem acredita', diz Goucha }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/2 occurences of hate speech related comments.\end{itemize}\end{document}