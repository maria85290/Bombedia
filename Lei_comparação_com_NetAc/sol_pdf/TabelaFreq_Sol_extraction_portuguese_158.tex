...
\textbf {\huge In Sol\_extraction\_portuguese\_158.json :}\newline \par\Large\textbf {Title: \large  Foi um descuido afirma padre após publicar fotografia em cuecas nas redes sociais }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/7 occurences of hate speech related comments.\end{itemize}\end{document}