...
\textbf {\huge In Sol\_extraction\_portuguese\_32.json :}\newline \par\Large\textbf {Title: \large  Você na TV. 'Nunca mais vai ser como era'? Goucha responde a seguidora | FOTO }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/4 occurences of hate speech related comments.\end{itemize}\end{document}