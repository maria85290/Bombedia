...
\textbf {\huge In Sol\_extraction\_portuguese\_173.json :}\newline \par\Large\textbf {Title: \large  Cristina Ferreira mostra mais do que queria em fotografia }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/16 occurences of hate speech related comments.\end{itemize}\end{document}