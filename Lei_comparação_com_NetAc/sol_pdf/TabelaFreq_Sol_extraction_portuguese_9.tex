...
\textbf {\huge In Sol\_extraction\_portuguese\_9.json :}\newline \par\Large\textbf {Title: \large  Manuel Luís Goucha brinca com telefonema de Marcelo a Cristina Ferreira }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/3 occurences of hate speech related comments.\end{itemize}\end{document}