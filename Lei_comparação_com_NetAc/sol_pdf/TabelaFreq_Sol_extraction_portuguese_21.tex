...
\textbf {\huge In Sol\_extraction\_portuguese\_21.json :}\newline \par\Large\textbf {Title: \large  Férias de Cristina Ferreira quase deram vitória a Manuel Luís Goucha }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/8 occurences of hate speech related comments.\end{itemize}\end{document}