...
\textbf {\huge In Sol\_extraction\_portuguese\_33.json :}\newline \par\Large\textbf {Title: \large  Manuel Luís Goucha e Cristina Ferreira iniciam programas de forma semelhante }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/5 occurences of hate speech related comments.\end{itemize}\end{document}