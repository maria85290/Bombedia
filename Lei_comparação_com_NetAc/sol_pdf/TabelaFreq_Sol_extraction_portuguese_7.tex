...
\textbf {\huge In Sol\_extraction\_portuguese\_7.json :}\newline \par\Large\textbf {Title: \large  Manuel Luís Goucha defende Judite Sousa: 'Tenho vergonha de seres humanos assim'}\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/20 occurences of hate speech related comments.\end{itemize}\end{document}