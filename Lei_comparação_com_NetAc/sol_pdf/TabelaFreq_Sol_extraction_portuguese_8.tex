...
\textbf {\huge In Sol\_extraction\_portuguese\_8.json :}\newline \par\Large\textbf {Title: \large  Goucha comenta piada do marido: 'Nem eu resisto a um arroz de pato ou a uma canja de pombo' }\newline {\par\large --- Table  1: Summary of the results per comment; }
