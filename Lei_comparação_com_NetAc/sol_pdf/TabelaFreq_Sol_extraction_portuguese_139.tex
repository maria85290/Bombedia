...
\textbf {\huge In Sol\_extraction\_portuguese\_139.json :}\newline \par\Large\textbf {Title: \large  Após teste negativo, Fernando Rocha volta a testar positivo para covid-19 }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/12 occurences of hate speech related comments.\end{itemize}\end{document}