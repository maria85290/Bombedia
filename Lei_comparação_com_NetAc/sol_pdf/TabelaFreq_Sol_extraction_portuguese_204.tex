...
\textbf {\huge In Sol\_extraction\_portuguese\_204.json :}\newline \par\Large\textbf {Title: \large  Marta Temido considera que votar contra OE ̩ desistir de melhorar os servi̤os p̼blicos de sa̼de }\newline {\par\large --- Table  1: Summary of the results per comment; }
...
\item Overall there were 0/10 occurences of hate speech related comments.\end{itemize}\end{document}